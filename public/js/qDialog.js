  ...
  $.extend(dialog.prototype, {
    _init : function(){
      ...
      // admin
        ...
        this.innerBox = $('<div class="float-prompt-middle aceContent"></div>');
        //this.contentBox = $('<div class="aceContent"></div>');
        this.footerBox = $('<div class="aceFooter float-prompt-bottom clearfix"></div>');
        ...
        this.okBtn = $('<button type="button" class="okBtn btn btn-success btn-sm" style="margin-left:110px;">'+this.opts.okValue+'</button>').click(function(){
